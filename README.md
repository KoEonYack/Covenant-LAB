...
- 20년 05월: [모인활 대시보드](https://koeonyack.github.io/aiforall-dashboard/) 5월 페이지 뷰 1000회 달성 
  - [Tistory 후기: 수업 대시보드 제작 후기 (부제: 컴공이 코로나 19를 대응하는 자세)](https://covenant.tistory.com/183)
...
- 2019 한국컴퓨터종합학술대회  학부생/주니어논문경진대회 학부생 부분 우수상
  ...
  - [Tistory 후기. 한국컴퓨터종합학술대회(KCC) 2019 학부생 논문경진대회에서 우수상을 수상하기까지](https://covenant.tistory.com/122?category=730893)
...
## 💡 강의 일정
 ...
 - 21년 초반: Go 언어로 시작하는 주니어 서버개발자 포트폴리오
 - 21년 중반: 코딩테스트 합격을 위한 시작이야 알고리즘(STEP 1)
 - 21년 중반: 코딩테스트 합격을 위한 두려워마 알고리즘(STEP 2-1) 
 - 21년 중반: 코딩테스트 합격을 위한 두려워마 알고리즘[문제편] (STEP 2-2) 
